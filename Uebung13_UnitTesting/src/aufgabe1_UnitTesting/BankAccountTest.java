...
public class BankAccountTest {
	...
	public void testTransferToSameACC() throws BankLimitException{
		...
		assertEquals("Transfer auf gleichen Account ändert Balance", balance, acc.getBalance());
	}
	...
	public void testTransferAmountMaxLong() throws BankLimitException{
		...
		assertEquals("Transfere Long.MAX:VALUE + 1 ändert ???", balanced1, acc1.getBalance());
		assertEquals("Transfere Long.MAX:VALUE + 1 ändert ???", balanced2, acc2.getBalance());
	}
